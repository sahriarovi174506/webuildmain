...
// expandbox
const miximg_expand = document.querySelectorAll(".miximg_expand");
const expanded_img = document.querySelector(".expanded_img");
miximg_expand.forEach((expand_btn) => {
	expand_btn.addEventListener("click", function () {
		const getParent = this.parentElement.parentElement;
		const getimgbox = getParent.querySelector("img").getAttribute("src");
		expanded_img.setAttribute("src", getimgbox)
		document.querySelector(".expands_box").classList.add("Expanded")
	});
});
const expand_remove = document.querySelector(".expand_remove");
expand_remove.addEventListener("click", function () {
	document.querySelector(".expands_box").classList.remove("Expanded")
